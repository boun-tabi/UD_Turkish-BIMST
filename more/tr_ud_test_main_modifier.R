...
tb <- udpipe_read_conllu("../../Treebanks/tr-ud-test-to-modify.conllu")
...
modifications <- read_excel("../../Annotations/tr-ud-test-annotation.xlsx", 
                            sheet = "0-975 - Test-Dev-Conllu-Annotat")
...
# Load the annotation excel sheet from the directory
modifications_2 <- read_excel("../../Annotations/tr-ud-test-annotation.xlsx", 
...
advcl_modifier <- read_excel("../../Annotations/tr-ud-test-added-advcl-annotation.xlsx",sheet = "Sheet 1 - tb_test_svd", col_types = c("numeric", "text", "numeric", "text", "text"))
...
cat(tb_nmod_advcl_modifier_conllu, file = file("../../Treebanks/tr-ud-test-finished.conllu", encoding = "UTF-8"))

#write.csv2(tb_nmod_advcl_modifier_conllu, file = file("test-real-finished.csv", encoding = "UTF-8"))
